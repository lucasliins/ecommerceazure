...
BLOB_CONNECTION_STRING = "DefaultEndpointsProtocol=https;AccountName=stadevlab001eastus;AccountKey=OKWSLWsRrs69XnmBU27wFhh1AKbOWutCSvBY83M1vQCQj1uTrCAHSmG54AxpmzVX/HUa/ar82iX++AStIPLb9Q==;EndpointSuffix=core.windows.net"
BLOB_CONTAINER_NAME = "fotos"
BLOB_ACCOUNT_NAME = "stadevlab001eastus"

# Configurações do Azure SQL Server
SQL_SERVER   = "dbsrvdeveastuslab0012.database.windows.net"
SQL_DATABASE = "sqllab001databasedeveastus"
SQL_USERNAME = "lucaslinsadminuser2807"
SQL_PASSWORD = "Quiteria64Aragao@"
